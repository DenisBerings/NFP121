...
// On implémente la classe java Observer
public class View implements Observer {
    ...
    public void update(Observable observable, Object o) {
        // Si la variable "observable" est un nombre...
        if(observable instanceof Number) {
            // ...on récupère la valeur transmise et on s'assure qu'elle est converti en nombre...
